//
//  skrypt wejscia na pozycje SHORT bez klikania na gieldzie ByBit
...
async function main() {
 ...
 const cenaPoczatkowa = response.result.a[0][0]; // API pobiera aktualna cene
        ...
        let wzrostProcentowy = 0.6;  //  ile procenty
 ...
 let cenaPoZ = zwiekszCeneOWzrost(cenaP, wzrostProcentowy);  // samo się tlumaczy 
      ...
      console.log('T: ' + cenaPoZ); // TakeProfit 
        const orderResponse = await client.submitOrder({   // dane przesylana do API 
            ...
            positionIdx: 0,
            orderType: 'Limit',
            qty: '0.003',    // zmienna wyliczana na podstawie dziwgni + ile masz w portfelu - najlepiej ustawić ręcznie, metodą prób i błędów 
            price: `${cenaP}`,
            timeInForce: 'GTC',
            takeProfit: `${cenaPoZ}`,
            isLeverage: '0'
